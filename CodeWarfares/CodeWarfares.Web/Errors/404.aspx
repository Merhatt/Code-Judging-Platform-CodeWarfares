<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="CodeWarfares.Web.Errors._404" %>
 ...
 */
    ...
    <div class="wrap">
        ...
        <div class="content">
            ...
            <p><span>
                <label>О</label>хх..... </span>Страницата, която търсите не съществува.</p>
        </div>
        <!--End-Cotent------>
    </div>
</asp:Content>
